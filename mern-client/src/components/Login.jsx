  ...
  return (
	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <p>If you dont't have an account. Please <Link to="/sign-up" className='text-blue-700 underline'>Sign-Up</Link></p>
						<div className="relative">
				...
				<div className='flex w-full items-center flex-col mt-5 gap-3'>
					<button onClick={handleRegister} className='block' ><img src={googleLogo} className='w-12 h-12 inline-block'/>
						Login with Google
					</button>
				</div>
			</div>
